...
public class IconHelper {
    ...
    private static final Map<String, Integer> ICON_MAP = new HashMap<String, Integer>() {{
        ...
        put("ac", R.drawable.ic_service_wifi); // Usar mientras no tengas ic_ac
        put("tv", R.drawable.ic_service_wifi); // Usar mientras no tengas ic_tv
        ...
        put("bed", R.drawable.ic_room); // Usar mientras no tengas ic_bed

...
public class ClientEditProfileItem {
    ...
    public ClientEditProfileItem(EditItemType type, String title, String value, String key,
    ...
    // Getters
    public EditItemType getType() { return type; }
    ...
    // Setters
    public void setType(EditItemType type) { this.type = type; }
